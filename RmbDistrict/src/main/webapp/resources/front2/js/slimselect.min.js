        ...
        var l = i(0),
            ...
            s = function () {
                ...
                return e.prototype.containerDiv = function () {
                    ...
                    return this.main.config.showSearch || (e.classList.add(this.main.config.hide), s.readOnly = !0), s.type = "search", s.placeholder = this.main.config.searchPlaceholder, s.tabIndex = 0, s.onclick = function (e) {
                        setTimeout(function () {
                        ...
                        if (n.main.addable) {
                            ...
                            else n.main.addData(n.main.data.newOption({
                                text: i,
                                value: i
                            })), s = i;
                    ...
                    for (var n = 0, a = i; n < a.length; n++) {
                        ...
                        if (l.hasOwnProperty("label")) {
                            ...
                            c.classList.add(this.main.config.optgroupLabel), this.main.config.selectByGroup && this.main.config.isMultiple && c.classList.add(this.main.config.optgroupLabelSelectable), c.innerHTML = o.label, r.appendChild(c);
                            var h = o.options;
                            if (h) {
                                ...
                                this.main.config.selectByGroup && this.main.config.isMultiple && (c.onclick = function (i) {
                                    return function () {
                    ...
                    return i.addEventListener("click", function (e) {
                        if (e.preventDefault(), e.stopPropagation(), !(a.main.config.limit && Array.isArray(n) && a.main.config.limit <= n.length)) {
                            ...
                            if (a.main.beforeOnChange) {
                                ...
                                s.selected = !0, a.main.config.isMultiple ? (i = JSON.parse(JSON.stringify(n))).push(s) : i = JSON.parse(JSON.stringify(s)), !1 !== a.main.beforeOnChange(i) && a.main.set(t, "id", a.main.config.closeOnSelect)
                            } else a.main.set(t, "id", a.main.config.closeOnSelect)
                        }
                    }), (e.disabled || n && l.isValueInArrayOfObjects(n, "id", e.id)) && (i.onclick = null, i.classList.add(this.main.config.disabled)), i
                }, e
            }();
        t.Slim = s
    }]).default
