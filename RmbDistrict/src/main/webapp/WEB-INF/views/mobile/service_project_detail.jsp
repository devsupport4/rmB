...
<html lang="en">
	<head>
		...
		<title>  Gyan Jyot    | Rotary Means Business Fellowship Bangalore  </title>
	...
	<body class="homepage" ng-app="rcbs" ng-controller="serviceProjectCtrl" ng-init="getServiceProjectDetailById(<%= request.getParameter("id")%>)">		
		<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
			<%@include file="header.jsp" %>
			<%@include file="sidebar.jsp" %>			
			<main class="mdl-layout__content">
				<div class="mdl-card__title mdl-color--darkblue mdl-color-text--white relative mdl-subheader">
					<a href="<%= request.getContextPath() %>/service_projects" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--icon">
						<i class="material-icons txt-dark">arrow_back</i>
					</a>
					<h2 class="mdl-card__title-text uppercase-font font-18">{{projecttitle}}</h2>
				</div>
				<div class="page-content">
					<div class="mdl-layout mdl-js-layout">
						<section class="club-detail">
							<div class="page-content club-detail">
								<div href="<%= request.getContextPath() %>/news-detail" class="mdl-card mdl-shadow--2dp demo-card-wide">
									<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
												
												<div class="carousel-inner">
													<div class="item active" ng-repeat="item in serviceprojectrelatedimages" ng-if="$index == 0">
														<div align="center" style="background-color: black;">
															<img class="img-responsive" src="{{item.image}}" alt="{{item.imageTitle}}">
														</div>														
													</div>
													<div class="item" ng-repeat="item in serviceprojectrelatedimages" ng-if="$index == 1">
														<div align="center" style="background-color: black;">
															<img class="img-responsive" src="{{item.image}}" alt="{{item.imageTitle}}">
														</div>														
													</div>
													<div class="item" ng-repeat="item in serviceprojectrelatedimages" ng-if="$index == 2">
														<div align="center" style="background-color: black;">
															<img class="img-responsive" src="{{item.image}}" alt="{{item.imageTitle}}">
														</div>														
													</div>													
									...
									<div class="mdl-card__supporting-text">
										<p style="margin-top:10px;"><div ng-bind-html="description | to_trusted"></div></p>
									</div>									
								</div>								
							</div>
						</section>
