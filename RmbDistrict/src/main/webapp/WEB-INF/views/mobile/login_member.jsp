...
<html lang="en">
	...
	<body class="homepage" ng-app="rcbs" ng-controller="eventDetailCtrl">
				...
				<div class = "mdl-grid">
					<div class="login mdl-cell mdl-cell--12-col mdl-cell--12-col-tablet mdl-cell--12-col-phone graybox">
						...
						<div class="mdl-card mdl-shadow--6dp">
							...
							<div class="mdl-card__supporting-text wd-90">
								<form >
									<div class="mdl-textfield mdl-js-textfield">
										<input name="username" id="username" ng-model="username" class="mdl-textfield__input" type="email" placeholder="USERNAME" autofocus="autofocus">
									...
									<div class="mdl-textfield mdl-js-textfield">
										<div align="center">
											<button ng-click="checkMemberLogin(<%= request.getParameter("eid")%>,'<%= request.getParameter("membertype")%>')" type="submit" class="btn btn-primary btn-lg btn-block" style="width: 90%; margin-top: 40px; ">Login</button>
										</div>
										<div>
