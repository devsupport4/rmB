...
<html lang="en">
	<head>
		...
		<title> All Wall Posts | Rotary Means Business Fellowship Bangalore </title>
		...
		<script src="<%=request.getContextPath() %>/resources/admin/js/controller/wall_posts.js"></script>
	...
	<style> 
		...
		#new_status .form-control {
		    width: 100%;
		}
	</style>
	<body class="homepage" ng-app="rcbs" ng-controller="wallPostCtrl" ng-init="getCurrentDefaultYear()">
		<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
			...
			<main class="mdl-layout__content">
				<div class="mdl-card__title mdl-color--darkblue mdl-color-text--white relative mdl-subheader">
					...
					<h2 class="mdl-card__title-text uppercase-font font-18">RMBFB Wall</h2>
				</div>
									...
									<div class="panel-body">
										<div class="col-sm-12 col-xs-12 wow fadeInDown animated" align="right">
											<div class="input-group" style="width:100%;">
												<div id="post-row" class="row">
													<div class="col-xs-12 col-sm-12 box-bord" id="new_status">
														<ul class="navbar-nav col-xs-12" id="post_header" role="navigation">
															<li style="list-style-type:none;" class="colr"><a href="#" class="post-color"><span class="glyphicon glyphicon-pencil"></span> RMBB Wall </a></li>
														</ul>
														<form>
												...
												<div id="main feed" class="row" ng-repeat="item in allmemberpost" ng-show="$index<=4">
