...
<html lang="en">
	<head>
		...
		<title> Board Of Directors | Rotary Means Business Fellowship Bangalore   </title>
		...
		<script src="<%=request.getContextPath() %>/resources/admin/js/controller/board_of_director.js"></script>
	...
	<body class="homepage" ng-app="rcbs" ng-controller="boardOfDirectorCtrl" ng-init="getDefaultYear()">	
		<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
			...
			<main class="mdl-layout__content">
				<div class="mdl-card__title mdl-color--darkblue mdl-color-text--white relative mdl-subheader">
					...
					<h2 class="mdl-card__title-text uppercase-font font-18"> Board Of Directors &nbsp;  <span class="pull-right"></span></h2>
				</div>
							...
							<div class="page-content">					
								<div class="panel panel-default year-box">
									<div class="panel-body">
										<div class="form-group">
											<select class="form-control input-lg" id="rotaryyearid" name="rotaryyearid" ng-model="rotaryyearid" ng-options="item.rotaryYearId as item.rotaryYearTitle for item in rotaryyear" ng-change="getBoardOfDirectorsDetailByRotaryYear()">
								...
								<div class="mdl-card  demo-card-wide committee">
									<div class="panel-group d-accordion">
										<div class="panel panel-default" ng-repeat="item in getboardofdirectorsbyrotaryyear">
