...
<html lang="en">
	<head>
		...
		<title>   Social Media |  Rotary Means Business Fellowship Bangalore </title>
		...
		<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
			...
			<main class="mdl-layout__content">
				<div class="mdl-card__title mdl-color--darkblue mdl-color-text--white relative mdl-subheader">
					...
					<h2 class="mdl-card__title-text uppercase-font font-18"> Social Media &nbsp;  <span class="pull-right"></span></h2>
				</div>
							...
							<div class="page-content">					
	  							<div class="panel panel-default year-box">
									<div class="panel-body">
										<h4> CONNECT WITH RCBS <span class="head-line"></span></h4>
										<div class="social-media">
											<ul class="social-share col-sm-4 col-xs-4" ng-repeat="item in getsocialmedialinks">
												
														<li>
															<a class="social-{{item.socialMediaPlatformTitle}}" target="_blank" href="{{item.socialMediaUrl}}"><i class="fa fa-{{item.socialMediaPlatformTitle}}"></i></a>
														</li>
