...
<html lang="en">
	...
	<body class="homepage" ng-app="rcbs" ng-controller="memberProfileCtrl" ng-cloak ng-init="getMemberDetailById(<%= request.getParameter("id")%>)">
		<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
			<%@include file="header.jsp" %>
			<%@include file="sidebar.jsp" %>
			<main class="mdl-layout__content">
				<div class="mdl-card__title mdl-color--darkblue mdl-color-text--white relative mdl-subheader">
					<a href="{{urlRed}}" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--icon">
						<i class="material-icons txt-dark">arrow_back</i>
					</a>
					<h2 class="mdl-card__title-text uppercase-font font-18"> Member Profile </h2>
				</div>
					...
					<div class="mdl-layout mdl-js-layout">
						<section class="profile">
							<div class="page-content">
								...
								<div class="details">
									<h3> {{getmemberdetail.memberFirstName}} {{getmemberdetail.memberMiddleName}} {{getmemberdetail.memberLastName}} </h3>
									<p class="mb-10"> {{getmemberdetail.memberDesignation}}, {{getmemberdetail.memberCompanyName}}</p>
