...
<html lang="en">
	<head>
		...
		<title>Add Business Transaction | Rotary Means Business Fellowship Bangalore  </title>
		...
		<script src="<%=request.getContextPath() %>/resources/admin/js/controller/thankyou_slip.js"></script>
	...
	<body class="homepage" ng-app="rcbs" ng-controller="thankYouSlipCtrl">
				...
				<div class = "mdl-grid">
					<div class="login mdl-cell mdl-cell--12-col mdl-cell--12-col-tablet mdl-cell--12-col-phone graybox">						
						<div class="mdl-card mdl-shadow--6dp">
							<div class="mdl-card__title mdl-color-text--white" style="background-color:#963737;">
								<h2 class="mdl-card__title-text">Say Thank you for your closed business </h2>
							</div>
							<div class="mdl-card__supporting-text">
								<form>									
									...
									<div class="row">
										<div class="col-xs-12">
											<div class="form-group">
												...
												<input type="number" class="form-control" name="amount" id="amount" ng-model="amount" style="text-align: right;">														
											</div>
										</div>
									</div>									
									<div class="row">
										<div class="col-xs-12">
											<div class="form-group">
												...
												<input class="KendoDate" id="datepicker" ng-model="slipdate" title="Select Date" placeholder="DD/MM/YYYY" style="width: 100%;"/>														
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-xs-12">
											<div class="form-group">
												...
												<label class="radio-inline"><input type="radio" name="optradio" ng-model="businesstype" value="New">New</label>
												<label class="radio-inline"><input type="radio" name="optradio" ng-model="businesstype" value="Repeat">Repeat</label>																			
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-xs-12">
											<div class="form-group">
												...
												<label class="radio-inline"><input type="radio" name="optradio1" ng-model="referraltype" value="Inside">Inside</label>
												<label class="radio-inline"><input type="radio" name="optradio1" ng-model="referraltype" value="Outside">Outside</label>
												<label class="radio-inline"><input type="radio" name="optradio1" ng-model="referraltype" value="Tier 3+">Tier 3+</label>
											</div>
										</div>
									</div>									
									<div class="row">
									...
									<div class="row">
										...
										<div class="col-xs-6">
											<div align="center">												
												<button type="submit" ng-click="saveThankYouSlip(flag='save')" class="btn btn-primary btn-lg btn-block bcgrdcor" style="width: 100%; ">Save</button>
											</div>
										</div>										
									</div>
									<div class="row mt-10">
										<div class="col-xs-12">
											<div align="center">
												<button type="submit" ng-click="saveThankYouSlip(flag='new')" class="btn btn-primary btn-lg btn-block backgrdclr" style="width: 100%; ">Save & New</button>												
											</div>
										</div>																			
									</div>
								</form>
