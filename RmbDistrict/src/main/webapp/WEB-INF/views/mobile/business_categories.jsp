		...
		<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
			...
			<main class="mdl-layout__content">
				<div class="mdl-card__title mdl-color--darkblue mdl-color-text--white relative mdl-subheader">
					...
					<h2 class="mdl-card__title-text uppercase-font font-18">Business Categories</h2>
				</div>
									...
									<div class="panel-body">
										<div class="col-sm-12 col-xs-12 wow fadeInDown animated" align="right">
											<div class="input-group" style="width:100%;">
												<input type="text" id="search" name="search" ng-model="search" autocomplete="off" class="form-control search_box" placeholder="Search Member" ng-keyup="$event.keyCode == 13 ? searchByCategory(search) : null"/>
								...
								<div class="mdl-card  demo-card-wide committee directory">
									<div class="panel-group d-accordion">
										<div class="panel panel-default bordercolor">										
											<li ng-repeat="item in getLastTenCategoriesForHome" style="list-style-type:none; padding: 7px;"><i class="fa fa-angle-double-right" aria-hidden="true" style="color: red;"></i><a href="#" style="color:#023572;"  ng-click="searchByCategory(item.businessCategoryName)"><b>{{item.businessCategoryName}}</b></a></li> <br>
										</div>									
									</div>								
								</div>																				
							</div>
