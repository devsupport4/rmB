...
<html lang="en">
	<head>
		...
		<title>    Member's Business | Rotary Means Business Fellowship Bangalore   </title>				
	...
	<body class="homepage" ng-app="rcbs" ng-controller="businessTransactionCtrl" ng-init="getMembersBusinessById('<%= session.getAttribute("loginid") %>','<%= session.getAttribute("fromdate") %>','<%= session.getAttribute("todate") %>')" ng-cloak>
											...
											<div class="panel-heading">
												<div class="row row-margin">
													<div class="col-xs-4 pl-0">
														...
														<h4 class="panel-title linelnt" style="font-size:13px">Amount</h4>
													</div>
													<div class="col-xs-8 pl-0">
														<h4 class="panel-title linelnt" style="font-size:13px">Thank you to</h4>
														<h4 class="panel-title linelnt" style="font-size:13px">New/Repeat Business</h4>
													</div>
												</div>
												
											</div>											
										</div>
										<div ng-repeat="item in getMemberBusiness">
											<div class="panel panel-default" >
												<div class="panel-heading" data-toggle="collapse" data-parent=".d-accordion" href="#whoweare{{item.thankYouSlipId}}">
												
													<div class="row row-margin">
														<div class="col-xs-4 pl-0">
															<h4 class="panel-title linelnt" style="font-size:14px">{{item.slipDate}}</h4>
															<h4 class="panel-title linelnt" style="font-size:14px">{{item.amount | number:2}}</h4>
														</div>
														<div class="col-xs-7 pl-0">
															<h4 class="panel-title linelnt" style="font-size:13px">{{item.memberFirstName}} {{item.memberLastName}}</h4>
															<h4 class="panel-title linelnt" style="font-size:13px">{{item.businessType}}</h4>
														</div>
												...
												<div id="whoweare{{item.thankYouSlipId}}" class="panel-collapse collapse">
													<ul class="list-group">												
														
														<li class="list-group-item"><i class="fa fa-file-text-o" aria-hidden="true"></i>{{item.referralType}}</li>
