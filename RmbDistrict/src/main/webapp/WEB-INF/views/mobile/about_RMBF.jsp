...
<html lang="en">
	<head>
		...
		<title>  About RMBFB   | Rotary Means Business Fellowship Bangalore </title>		
		...
		<script src="<%=request.getContextPath() %>/resources/admin/js/controller/club_news.js"></script>
		...
		<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
			...
			<main class="mdl-layout__content">
				<div class="mdl-card__title mdl-color--darkblue mdl-color-text--white relative mdl-subheader">
					...
					<h2 class="mdl-card__title-text uppercase-font font-18">About RMBFB &nbsp; <span class="pull-right"></span>  </h2>
				</div>
				<div class="page-content">
					<div class="mdl-layout mdl-js-layout">
						<section class="club-news">
							<div class="page-content club-news mdl-card mdl-shadow--2dp demo-card-wide  mdl-js-ripple-effect">
								<span class="mdl-ripple"></span>
								<div class="mdl-card__title">									
										<img src="<%=request.getContextPath() %>/resources/front1/images/about-rmbv.jpg"  alt=" " style="width: 100%;" />									
								</div>
								<div class="mdl-card__supporting-text">
									<h4>ABOUT ROTARY MEANS BUSINESS FELLOWSHIP BANGALORE</h4>																	
