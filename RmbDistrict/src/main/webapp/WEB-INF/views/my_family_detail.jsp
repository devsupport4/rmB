...
.navbar{
	...
	<body ng-app="rcbs" ng-controller="myFamilyDetailCtrl" ng-init="getspousedetail(<%= session.getAttribute("loginid")%>)" ng-cloak>	
				...
				<div class="container pageTitle">
					<div class="row">
						...
						<div class="col-md-6 col-sm-6 text-right">
							<span class="page-location"><a href="<%=request.getContextPath() %>/">Home</a> /  My Family Detail  </span>
						</div>
					</div>
				</div>
			</div>
														...
														<div class="panel panel-default">
															<div class="panel-heading" style="border-top: 2px solid blue; background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #e2e2e2), color-stop(1, #fafafa));">
																<div class="row" style="color: #333;">
																	...
																	<div class="col-md-2">
																		<a data-toggle="modal"data-target="#squarespaceModal1" class="btn btn-info right-block" ng-click="spousememberid('<%= session.getAttribute("membershipnumber") %>', '<%= session.getAttribute("loginid") %>')">ADD FAMILY MEMBER</a>
															...
															<div class="row">
																...
																<div class="col-md-10">
																	<div style="padding: 1px 10px 0px 0px;  margin-top: -20px;">
																		<nav aria-label="...">
																			<ul class="pager">
																				<li class="next"><a ng-click="redirectreference(membercategoryid,2)" style="float: right; padding: 10px 20px; background-color: #fff; border: 1px solid #ddd; border-radius: 15px; cursor: pointer; cursor: hand; margin-left: 10px;">Next</a></li>
																			</ul>
																		</nav>
																	</div>
																</div>
