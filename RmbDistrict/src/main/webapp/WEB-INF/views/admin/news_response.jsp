...
<body ng-app="rcbs" ng-controller="newsResponseCtrl">
	<%@include file="header.jsp"%>
	<div class="container text-center">
		<h3 style="color: #db3615">News Response</h3>
	</div>
					...
					<form role="form" ng-submit="deletenews()">
						<div class="table-responsive">
							<table id="mytable" class="table table-bordred table-striped">
								...
								<tbody>
									<tr ng-repeat="item in newsresponsecounts"
										style="cursor: pointer; cursor: hand">
										<td data-toggle="modal" data-target="#myModal"
											ng-click='getNewsResponceDetail(item.newsId)'>{{item.newsTitle}}</td>
										<td data-toggle="modal" data-target="#myModal"
											ng-click='getNewsResponceDate(item.newsId)'>{{item.newsDate}}</td>
									</tr>
								</tbody>
							</table>
			...
			<div class="row">
				<div class="col-md-12 text-center">
					...
					<button type="submit" class="btn btn-primary"
						ng-disabled="currentPage >= eventresponsecounts.length/pageSize - 1"
						ng-click="currentPage=currentPage+1">
				...
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title">{{eventtitle}} Event Response
								Details</h4>
						</div>
						<div class="modal-body">
							...
							<div class="table-responsive">
								<table id="mytable" class="table table-bordred table-striped">
									...
									<tbody>
										<tr ng-repeat="item in comingmembers"
											ng-if="item.firstname != null">
							...
							<div class="row">
								<div class="col-md-12" align="center">
									<h4>
										<b>Members Who Are Not Coming</b>
									</h4>
								</div>
							</div>
							<div class="table-responsive">
								<table id="mytable" class="table table-bordred table-striped">
									...
									<tbody>
										<tr ng-repeat="item in notcomingmembers"
											ng-if="item.firstname != null">
											<td>{{item.firstname}} {{item.middlename}}
												{{item.lastname}}</td>
