...
<html lang="en">
	...
	<body ng-app="rcbs" ng-controller="manageContactDetailCtrl" ng-cloak ng-init="getcontactdetail(<%= request.getParameter("memberid")%>)">
							...
							<div class="tab-content">
								<div class="tab-pane fade in active" id="personal">
									<div class="col-md-12">	
										...
										<div class="row">
											<div class="col-md-2">
												<a href="" ng-click='redirectmemberdetail(<%=request.getParameter("memberid") %>)' style="float: right; padding: 10px 20px; background-color: #fff; border: 1px solid #ddd; border-radius: 15px; cursor: pointer; cursor: hand;">Previous</a>
											</div>
											<div class="col-md-10">
												<div style="padding: 1px 10px 0px 0px;  margin-top: -20px;">
													<nav aria-label="...">
														<ul class="pager">
															<li class="next"><a ng-click="redirectfamilydetail(<%=request.getParameter("memberid") %>, membercategoryid, tenureplan)" style="float: right; padding: 10px 20px; background-color: #fff; border: 1px solid #ddd; border-radius: 15px; cursor: pointer; cursor: hand; margin-left: 10px;">Next</a></li>
															<li class="next"><input type="submit" ng-click="editcontactdetail(memberid, membercategoryid, tenureplan)" value="Update & Next" style="float: right; padding: 10px 20px; background-color: #fff; border: 1px solid #ddd; border-radius: 15px;"></li>
														</ul>
													</nav>
												</div>
											</div>
