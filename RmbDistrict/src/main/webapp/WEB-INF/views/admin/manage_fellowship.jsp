...
<html lang="en">
	<head>
		<title>Manage Fellowship List</title>
		<meta charset="utf-8">
	...
	<body ng-app="rcbs" ng-controller="fellowshipCtrl" ng-init="getfellowshipList()">
		<%@include file="header.jsp" %>		
		<div class="panel-body">
			<div class="container">
				<div class="row panel panel-primary" style="width:auto;background-color:#eee;">
					<div class="col-md-4" align="left">
						<h3>Manage Fellowship</h3>					
					</div>
						...
						<form role="form" ng-submit="deleteClub()">
							<div class="table-responsive">
								<table id="mytable" class="table table-bordred table-striped">
									<thead>										
										<th width="75%">Fellowship Name</th>
									<!-- 	<th width="65%">Description</th>	 -->																		
										<th width="10%"><input type="checkbox" ng-model="selectedAll" ng-click="checkAll()"> All</th>
									</thead>
									 <tbody>
										<tr ng-repeat="item in getAllFellowshipNameList" style="cursor:pointer;cursor:hand">					
											<td data-toggle="modal" data-target="#EditClub" ng-click='getfellowshipName(item.fellowship_id)'>{{item.fellowship_name}}</td>					
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input type="text" class="form-control" id="fellowshi-name" name="fellowship_name" ng-model="fellowship.fellowship_name" placeholder="fellowship Name" autofocus>
											</div>
										</div>
									</div>
									 <div class="row">								
				...
				<div class="modal fade" id="AddClub" role="dialog">
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal">&times;</button>
								<h4 class="modal-title">Add Fellowship Info</h4>
							</div>
							<div class="modal-body">							
								<form role="form">
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label>Fellowship Name<font color="red" size="3">*</font></label>									
												<input type="text" class="form-control" id="fellowship_name" name="fellowship_name" ng-model="fellowship.fellowship_name" placeholder="fellowship Name" autofocus>
											</div>
										</div>
									</div>
									 <div class="row">								
							...
							<div class="modal-footer">
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									<button type="button" ng-click="addfellowship()" class="btn btn-success">Save</button>
									<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
								</div>								
							</div>						
						</div>
