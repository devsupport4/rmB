...
<html lang="en">
	<head>
		...
		<script src="<%=request.getContextPath() %>/resources/admin/js/controller/roleAssign.js"></script>
	...
	<body ng-app="rcbs" ng-controller="roleAssignControl" ng-init="getAllRoles()">
		<%@include file="header.jsp" %>
		<div class="container text-center">
			<h3 style="color:#db3615">Manage Roles</h3>      
		</div>
					...
					<div class="col-md-12">
						<table width="100%">
							<tr>
								...
								<td width="15%">
									<div class="form-group" style="margin-top:15px;">
										<a href="#" data-toggle="modal" data-target="#addRoles" class="btn btn-success btn-default">Add Role &nbsp;<span class="glyphicon glyphicon-plus"></span></a>
									</div> 
								</td>
							</tr>
						</table>
							...
							<form role="form" name="event">
								<div class="row">
									<div class="col-md-3">
										<div class="form-group">
											<label>Roles</label>									
											<select class="form-control" name="roleid" id="roleid" ng-model="roleid" ng-options="role as role.label for role in Roles">
											</select>
											
										</div>
									</div>
									<div class="col-md-6" ng-hide='roleid == ""'>
										<div class="form-group">
											<label>Name of {{roleid.label}}</label>									
											<input type="text" class="form-control" id="memberName" name="memberName" ng-model="memberName">
										</div>
									</div>
								</div>	
								<div class="row" ng-hide='roleid == ""'>
									<h1><input type="checkbox" ng-change="selectAllEvent()" ng-model="eventsAll"> Events</h1>
									
										<input type="checkbox" ng-checked="manageEvent" ng-model="manageEvent">Manage Events {{manageEvent}}
										<input type="checkbox" ng-checked="manageEventRegistrationList" ng-model="manageEventRegistrationList">Event registration list {{manageEventRegistrationList}}
								</div>	
								<div class="row" ng-hide='roleid == ""'>
									<h1><input type="checkbox" ng-change="selectAllManage()" ng-model="manageAll"> Manage</h1>
									
										<input type="checkbox" ng-checked="news" ng-model="news">News &nbsp;&nbsp;
										<input type="checkbox" ng-checked="AwardsAndRecognition" ng-model="AwardsAndRecognition">Awards and recognitions &nbsp;&nbsp;
										<input type="checkbox" ng-checked="BeneficiaryType" ng-model="BeneficiaryType">Beneficiary Type &nbsp;&nbsp;
										<input type="checkbox" ng-checked="BoardofDirectors" ng-model="BoardofDirectors">Board of Directors &nbsp;&nbsp;
										<input type="checkbox" ng-checked="BusinessTransaction" ng-model="BusinessTransaction">Business Transaction &nbsp;&nbsp;
										<input type="checkbox" ng-checked="MembersMeeting" ng-model="MembersMeeting">Members Meeting &nbsp;&nbsp;
										<input type="checkbox" ng-checked="Reference" ng-model="Reference">Reference &nbsp;&nbsp;
										<input type="checkbox" ng-checked="BusinessCategories" ng-model="BusinessCategories">Business Categories &nbsp;&nbsp;
										<input type="checkbox" ng-checked="ClubBulletins" ng-model="ClubBulletins">Club Bulletins &nbsp;&nbsp;
										<input type="checkbox" ng-checked="RMBFBInfo" ng-model="RMBFBInfo">RMBFB Info &nbsp;&nbsp;
										<input type="checkbox" ng-checked="ClubList" ng-model="ClubList">Club List &nbsp;&nbsp;
										<input type="checkbox" ng-checked="DuesandBilling" ng-model="DuesandBilling">Dues and Billing &nbsp;&nbsp;
										<input type="checkbox" ng-checked="Members" ng-model="Members">Members &nbsp;&nbsp;
										<input type="checkbox" ng-checked="MembersCommittee" ng-model="MembersCommittee">Members Committee &nbsp;&nbsp;
										<input type="checkbox" ng-checked="PaymentHistory" ng-model="PaymentHistory">Payment History &nbsp;&nbsp;
										<input type="checkbox" ng-checked="PendingPayments" ng-model="PendingPayments">Pending Payments &nbsp;&nbsp;
										<input type="checkbox" ng-checked="PhotoAlbum" ng-model="PhotoAlbum">Photo Album &nbsp;&nbsp;
										<input type="checkbox" ng-checked="RotaryYear" ng-model="RotaryYear">Rotary Year &nbsp;&nbsp;
										<input type="checkbox" ng-checked="SocialMediaLinks" ng-model="SocialMediaLinks">Social Media Links &nbsp;&nbsp;
								</div>
								
								<div class="row" ng-hide='roleid == ""'>
									<h1><input type="checkbox" ng-change="selectAllOthers()" ng-model="othersAll"> Others</h1>
									
										<input type="checkbox" ng-checked="Payments" ng-model="Payments">Payments
										<input type="checkbox" ng-checked="Reports" ng-model="Reports">Reports
										<input type="checkbox" ng-checked="Mailer" ng-model="Mailer">Mailer
										<input type="checkbox" ng-checked="Master" ng-model="Master">Master
								...
								<div class="row">
									<div class="col-md-6"><br>
										<div class="form-group">
											<button type="submit" name="submit" ng-click="saveAndGenrateUsernamePassword()" class="btn btn-success" >Save</button>
											<a href="admin_roleAssign" class="btn btn-danger" data-dismiss="modal">Cancel</a>
											<span ng-show="spin == 1">Please wait to receive the username and password for the assigned role</span>								
										</div>
									</div>
									<div class="col-md-9">
