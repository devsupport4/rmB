...
<html lang="en">
	...
	<body ng-app="rcbs" ng-controller="albumCtrl">
		...
		<div class="container text-center">
			<h3 style="color:#db3615">Manage Photo Albums</h3>      
		</div>
		<div class="panel-body">
			<div class="container">
					...
					<div class="col-md-12">
						<table width="100%">
							<tr>
								...
								<td width="15%">
									<div class="form-group" style="margin-top:15px;">
										<a href="add_photo_album" class="btn btn-success btn-default">Add Photo Albums &nbsp;<span class="glyphicon glyphicon-plus"></span></a>
									</div> 
								</td>
							</tr>
						</table>
				...
				<div class="row">
					<div class="col-md-12">
						<form role="form" ng-submit="deletealbum()">
							<div class="table-responsive">
								<table id="mytable" class="table table-bordred table-striped">
									<thead>
										<th width="50%">Album Title</th>
										<th width="30%">Album Date</th>
										<th width="15%">Image</th>
										<th width="5%"><input type="checkbox" ng-model="selectedAll" ng-click="checkAll()"> All</th>
									</thead>
									<tbody>
										<tr ng-repeat="item in album | filter:search | startFrom:currentPage*pageSize | limitTo:pageSize" style="cursor:pointer;cursor:hand">
											<td data-toggle="modal" data-target="#myModal" ng-click='getalbum(item.albumId)'>{{item.albumTitle}}</td>
											<td data-toggle="modal" data-target="#myModal" ng-click='getalbum(item.albumId)'>{{item.albumDate | date: 'dd/MM/yyyy'}}</td>
											<td data-toggle="modal" data-target="#myModal2" ng-click='getalbum(item.albumId)'><span class="glyphicon glyphicon-picture"></span></td>
											<td><input type="checkbox" ng-model="item.selected" value="{{item.albumId}}"></td>
										</tr>
									</tbody>
								</table>
				...
				<div class="row">
					<div class="col-md-12 text-center" >
			    		...
			    		<button type="submit" class="btn btn-primary" ng-disabled="currentPage >= album.length/pageSize - 1" ng-click="currentPage=currentPage+1">
					...
					<!-- Modal content-->
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title">Album Images</h4>
							</div>
							<div class="modal-body">
								<table class="table table-striped">
									<tr class='list-group gallery'>
										<td ng-repeat="item in albumimage" style="float: left;">
				...
				<div class="modal fade" id="myModal" role="dialog" tabindex="-1">
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
							...
							<form role="form" ng-submit="editalbum(albumid)">
								<div class="modal-body">
									<div class="row">
										<div class="col-xs-12 col-sm-12 col-md-12">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														...
														<select class="form-control" id="project" name="project" ng-model="project" ng-options="item.serviceProjectId as item.serviceProjectTitle for item in serviceproject">
											...
											<div class="well">
												<div class="row">
													...
													<div class="col-md-1">
														<a class="btn btn-primary" ng-click="addAlbumImageRowEdit()">ADD</a>
													</div>
												</div>
												<table class="table table-hover">
													...
													<tr ng-repeat="item in albumimage">
													...
													<tr ng-repeat="item in albumimagenew" ng-show="item.imageTitle != null">
														...
														<td><a ng-click="removeAlbumImageRowEdit(item.imageTitle)" style="cursor: pointer;"><i class="fa fa-trash"></i></a></td>
													</tr>
												</table>
											</div>
										</div>
