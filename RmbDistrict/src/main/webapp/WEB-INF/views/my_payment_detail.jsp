...
<html>
	<head>
		<title> My Payment Detail | Rotary Means Business Fellowship Bangalore </title>
		<meta charset="UTF-8">
	...
	<body ng-app="rcbs" ng-controller="myPaymentCtrl" ng-init="getpayment(<%= session.getAttribute("loginid")%>)" ng-cloak>
														...
														<div class="row">
															...
															<div class="col-md-10">
																<div style="padding: 1px 10px 0px 0px;  margin-top: -20px;">
																	<nav aria-label="...">
																		<ul class="pager">													
																			<li class="next"><a href="<%=request.getContextPath() %>/my_profile">Next</a></li>
																		</ul>
																	</nav>
																</div>
															</div>
	...
	<div class="modal fade" id="editPaymentModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<form ng-submit="editpayment(paymentid,2)">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">X</span><span class="sr-only">Close</span></button>
