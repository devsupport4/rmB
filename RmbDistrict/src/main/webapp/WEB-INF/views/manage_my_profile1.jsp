...
<div class="form-group row">
		 ...
		 <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				...
				<div class="col-lg-3">
						<div class="form-group">
							...
							<input   class="KendoDate" id="aniversary" title="datepicker2" placeholder="DD/MM/YYYY" style="width: 100%;"/>
						</div>
					</div>		
	...
	<a id="Add" value="Add" name="Add" ng-click="addEducationRowEdit()" class="btn btn-primary btn-lg"  style="margin-top:27px;height: 43px"><span  style="color:white">&nbsp;Add </span></a>
	</span>
	</div>			</div>
				...
				<div class="row" ng-repeat="item in getmembereducationdetail">
							<div class="col-md-2">
								<div class="form-group">
									<label> &emsp;&emsp;{{item.degreeName}}</label>
								</div>
							</div>
							<div class="col-md-2">
								<div class="form-group">
							...
							<div class="col-md-2">
								<div class="form-group">
									<a class="btn btn-danger btn-sm" style="background-color: white;" ng-click="removeEducationRowEdit(item.degreeName)" ng-if="item.degreeName != null"/><i class="fa fa-trash-o txt-danger"></i></a>
								</div>
							</div>
						</div>
<hr>
